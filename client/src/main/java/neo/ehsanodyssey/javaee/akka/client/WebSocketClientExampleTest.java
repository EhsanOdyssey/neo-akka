package neo.ehsanodyssey.javaee.akka.client;
...
public class WebSocketClientExampleTest {
    ...
    public static void main(String[] args) {
        new WebSocketClientExampleTest().testWebSocketClientFlow();
    }
    ...
    public void testWebSocketClientFlow() {
        ...
        Flow<Message, Message, CompletionStage<WebSocketUpgradeResponse>> webSocketFlow =
                http.webSocketClientFlow(WebSocketRequest.create("ws://localhost:8080/greeter"));
